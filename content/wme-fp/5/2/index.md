...
description: "Explore the fundamentals of Canadian residential mortgages, including fixed- and variable-rate options, hybrid structures, qualification requirements, default insurance, and best practices for borrowers."
...
```mermaid
flowchart LR
    A[Borrower Prepares Financial Documents] --> B[Submits Application to Lender]
    B --> C[Lender Performs Credit Check & Income Verification]
    C --> D[Lender Calculates GDS & TDS Ratios]
    D --> E[Lender Provides Conditional Approval & Rate Offer]
    E --> F[Borrower Finalizes Down Payment & Closes Mortgage]
```
